...
export const liveApi = {
  ...
  verification: (signal?: AbortSignal) => request<VerificationSummary[]>("/skill/verification", signal),
...
export const fixtureApi = {
  ...
  replayEvent: async (id: string) => mockReplayDetails.find((e) => e.event_id === id) ?? mockReplayDetails[0],
};
